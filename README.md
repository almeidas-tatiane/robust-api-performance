...
- [Using NGINX Reverse Proxy to Secure Prometheus, Node Exporter, InfluxDB and Grafana](https://github.com/almeidas-tatiane/robust-api-performance/blob/main/docs/setup-nginx.md#deployment-strategy-note)
